...
//              Create the markers.
            ...
            <div class="row row-cols-1 row-cols-lg-1">
                <table style="font-size: 12px">
                    ...
                    <tr>
                        <td onclick="detail_sensors('` + sensor_data.module_id + `','` + sensor_data.module_desc + `','` + sensor_data.time + `')" colspan="2" style="background-color: ` + sensor_data.status + `; color: ` + sensor_data_c + `; border:2px solid white">Sensors</td>
                        <td onclick="detail_infra('` + infrastructure_data.module_id + `','` + infrastructure_data.module_desc + `','` + infrastructure_data.time + `')" colspan="10" style="background-color: ` + infrastructure_data.status + `; color: ` + infrastructure_data_c + `; border:2px solid white">Infrastructure</td>
                        <td onclick="detail_tx('` + tx_data.module_id + `','` + tx_data.module_desc + `','` + tx_data.time + `')" style="background-color: ` + tx_data.status + `; color: ` + tx_data_c + `; border:2px solid white">TX</td>
                        <td onclick="detail_switch1('` + switch1_data.module_id + `','` + switch1_data.module_desc + `','` + switch1_data.time + `')" style="background-color: ` + switch1_data.status + `; color: ` + switch1_data_c + `; border:2px solid white">SW1</td>
                        <td onclick="detail_switch2('` + switch2_data.module_id + `','` + switch2_data.module_desc + `','` + switch2_data.time + `')" style="background-color: ` + switch2_data.status + `; color: ` + switch2_data_c + `; border:2px solid white">SW2</td>
                    </tr>
                    <tr>
                        <td onclick="detail_mssr('` + mssr_data.module_id + `','` + mssr_data.module_desc + `','` + mssr_data.time + `')" style="background-color: ` + mssr_data.status + `; color: ` + mssr_data_c + `; border:2px solid white">MSSR-S</td>
                        <td onclick="detail_pedestal('` + pedestal_data.module_id + `','` + pedestal_data.module_desc + `','` + pedestal_data.time + `')" style="background-color: ` + pedestal_data.status + `; color: ` + pedestal_data_c + `; border:2px solid white">PEDESTAL</td>
                        <td onclick="detail_clock('` + clocks_data.module_id + `','` + clocks_data.module_desc + `','` + clocks_data.time + `')" colspan="2" style="background-color: ` + clocks_data.status + `; color: ` + clocks_data_c + `; border:2px solid white">Clocks</td>
                        <td onclick="detail_network('` + network_data.module_id + `','` + network_data.module_desc + `','` + network_data.time + `')" colspan="5" style="background-color: ` + network_data.status + `; color: ` + network_data_c + `; border:2px solid white">NETWORK</td>
                        <td onclick="detail_sdcs('` + sdcs_data.module_id + `','` + sdcs_data.module_desc + `','` + sdcs_data.time + `')" style="background-color: ` + sdcs_data.status + `; color: ` + sdcs_data_c + `; border:2px solid white">SDCS</td>
                        <td onclick="detail_aei('` + aei_data.module_id + `','` + aei_data.module_desc + `','` + aei_data.time + `')" style="background-color: ` + aei_data.status + `; color: ` + aei_data_c + `; border:2px solid white">AEI</td>
                        <td onclick="detail_cms('` + cms_data.module_id + `','` + cms_data.module_desc + `','` + cms_data.time + `')" style="background-color: ` + cms_data.status + `; color: ` + cms_data_c + `; border:2px solid white">CMS</td>
                    </tr>
                    <tr>
                        <td onclick="detail_rlu('` + detail.device_id + `')" style="background-color: ` + mssr_data.status + `; color: ` + mssr_data_c + `; border:2px solid white; visibility: ` + vis + `" id="rlu">LRU'S</td>
                        <td></td>
                        <td onclick="detail_ntp1('` + ntp1_data.module_id + `','` + ntp1_data.module_desc + `','` + ntp1_data.time + `')" style="background-color: ` + ntp1_data.status + `; color: ` + ntp1_data_c + `; border:2px solid white">NTP1</td>
                        <td onclick="detail_ntp2('` + ntp2_data.module_id + `','` + ntp2_data.module_desc + `','` + ntp2_data.time + `')" style="background-color: ` + ntp2_data.status + `; color: ` + ntp2_data_c + `; border:2px solid white">NTP2</td>
                        <td onclick="detail_lan1('` + lan1_data.module_id + `','` + lan1_data.module_desc + `','` + lan1_data.time + `')" style="background-color: ` + lan1_data.status + `; color: ` + lan1_data_c + `; border:2px solid white">L1</td>
                        <td onclick="detail_lan2('` + lan2_data.module_id + `','` + lan2_data.module_desc + `','` + lan2_data.time + `')" style="background-color: ` + lan2_data.status + `; color: ` + lan2_data_c + `; border:2px solid white">L2</td>
                        <td colspan="3"></td>
                    </tr>
